...
- **Porównywanie zmian w plikach** - możliwość porównywania zmian w różnych formatach plików (TXT, RTF, ODT, DOC, DOCX), jak również zmiany w arkuszach kalkulacyjnych (CSV, ODS, XLS, XLSX).
